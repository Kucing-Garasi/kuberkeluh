        ...
        <div className="flex flex-col justify-center items-center mb-44">
            <div className="flex justify-center">
                <div className="w-1/2 text-center my-4 px-4">
                    ...
                    <div className="my-3">
                        <Link to="/login" className="mx-2 bg-blue-500 text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:bg-blue-600 transition-colors duration-300">
                            Sign-In to Kuberkeluh
                        </Link>
                        <Link to="/welcome" className="mx-2 bg-pink-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:bg-pink-700 transition-colors duration-300">
                            Go to Welcome Page
                        </Link>
                    </div>
